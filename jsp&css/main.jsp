 ...
 <nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-brand ml-1;">
            <a href="#" target="_self"><img src="https://github.com/yoonseo1004/yoonseo/blob/main/images/search_logo.png?raw=true" width=60%
                alt="searchsearch" class="d-inline-block align-text-top"></a>
        </div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end"></div>
        <form class="d-flex">
            <div class="btn-group">
                <a class="btn btn-primary d-grid mx-auto" href="https://yoonseo1004.github.io/yoonseo/html&css/login.html" role="button">로그인</a>
                <a class="btn btn-primary d-grid mx-auto" href="https://yoonseo1004.github.io/yoonseo/html&css/join.html" role="button">회원가입</a>
...
<!-- 배경 이미지 -->
<div class="row">
	<div class="col mx-auto main_image">
	</div>
</div>
	...
	<div id="webcam-container"></div>
		...
		<div style="text-align: center">
			<a id="recommandCloth" href="recommand.jsp"><button
					style="visibility: hidden" id="recommand"
...
<div class="container">
    <footer class="py-3 my-4">
      ...
      <p class="text-center text-muted mb-4">&copy; 2022 searchsearch Company, Inc</p>
    </footer>
</div>
